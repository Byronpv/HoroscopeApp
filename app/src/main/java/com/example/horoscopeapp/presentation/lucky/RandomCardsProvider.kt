...
import com.example.horoscopeapp.presentation.lucky.model.LuckyModel
...
class RandomCardsProvider @Inject constructor() {
    ...
    fun getLucky(): LuckyModel = when (Random.nextInt(0, 33)) {
        ...
        15 -> LuckyModel(R.drawable.card_king_cups, R.string.app_name)
        ...
        22 -> LuckyModel(R.drawable.card_king_wands, R.string.app_name)
        ...
        27 -> LuckyModel(R.drawable.card_back, R.string.app_name)
        28 -> LuckyModel(R.drawable.card_lovers, R.string.app_name)
        29 -> LuckyModel(R.drawable.card_page_wands, R.string.app_name)
        30 -> LuckyModel(R.drawable.card_queen_cup, R.string.app_name)
        31 -> LuckyModel(R.drawable.card_queen_pentacles, R.string.app_name)
        32 -> LuckyModel(R.drawable.card_two_pentacles, R.string.app_name)
        33 -> LuckyModel(R.drawable.card_reverse, R.string.app_name)
